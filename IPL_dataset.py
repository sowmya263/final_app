...
with tab1: 
     st.title("IPL Dataset(2008 - 2019):")
     st.markdown("""Here is the dataset of IPL from 2008 to 2019 for Data visualization and analysis.
     IPL i.e: Indian Premier League is a men's T20 franchise cricket league of India.
     The league was founded by Board of Control for Cricket in India(BCCI) in 2007.""")

     st.markdown("This dataset consists of matches csv file.")
     dataset
...
logos = ['Sunrisers Hyderabad', 'Mumbai Indians', 'Gujarat Lions',
       ...
       'Delhi Capitals']
with tab2:
     st.title("The logos of different teams")
...
with tab3:
     ...
     st.markdown("From the graph, we can observe a irregular trend for 2011, 2012 and 2013 from the rest of the years.")
     st.markdown("As there are few more teams added to IPL for those 3 years, there are more number of matches played.")
